...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recPrecio.setText(datalist.get(position).getDataPrec());
        ...
        holder.resCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Language", datalist.get(holder.getAdapterPosition()).getDataPrec());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ImageView recImage;
        TextView recTitle, recDesc, recPrecio;
        CardView resCard;
        ...
        public MyViewHolder(@NonNull View itemView){
            ...
            recPrecio = itemView.findViewById(R.id.recPriority);
